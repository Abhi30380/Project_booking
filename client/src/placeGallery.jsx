            ...
            <div className="absolute inset-0 bg-black text-white min-h-screen">
                <div className="bg-black p-8 grid gap-4">
                    ...
                    {place?.addedPhotos?.length > 0 && place.addedPhotos.map(photo => (
                        <div>
                            <img className="w-full h-full" src={'http://localhost:3000/uploads/' + photo} alt="" />
                        </div>
                    ))}
                </div>
            </div>
        ...
        <div className="relative">
            <div className="grid gap-2 grid-cols-[2fr_1fr] rounded-2xl overflow-hidden">
                <div>
                    {place.addedPhotos?.[0] && (
                        <div>
                            <img className="aspect-square object-cover w-full" src={'http://localhost:3000/uploads/' + place.addedPhotos[0]} alt="" />
                        </div>
                ...
                <div className="grid">
                    {place.addedPhotos?.[1] && (
                        <img className="aspect-square object-cover w-full" src={'http://localhost:3000/uploads/' + place.addedPhotos[1]} alt="" />

                    )}
                    <div className="overflow-hidden">
                        {place.addedPhotos?.[2] && (
                            <img className="aspect-square object-cover relative top-2 w-full" src={'http://localhost:3000/uploads/' + place.addedPhotos[2]} alt="" />
